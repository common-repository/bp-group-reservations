...
class BP_Group_Reservation_Extension extends BP_Group_Extension {
	...
	function enable_nav_item() {
		...
		/** Only display the nav item for admins and those authorized to manage reservations */
	...
	function edit_screen() {
		...
		if(
			 ...
			 ! ( bp_is_groups_component() && $this->slug == bp_current_action() )
		) {
			return false;
		}
